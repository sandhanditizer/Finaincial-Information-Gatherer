...
class TestDeltaVolume(unittest.TestCase):
    ...
    def test_answer(self):
        ...
        result = compute_delta_volume('2022-01-12', 4265125132.0)
        self.assertEqual(result, -1.88)
...
class TesttdBreakawayMomentum(unittest.TestCase):
    def test_answer(self):
        """Found correct answer"""
        result = compute_td_breakaway_momentum('2022-01-12', 1968.0, 2698.0)
        self.assertEqual(result, 0.88)
...
class TestFDAdvanceDeclineThrust(unittest.TestCase):
    def test_answer(self):
        """Found correct answer"""
        result = compute_fd_advance_decline_thrust('2022-01-12', 1968.0, 2698.0)
        self.assertEqual(result, 46.75)
        
        
class TestFDUpDownVolume(unittest.TestCase):
    def test_answer(self):
        """Found correct answer"""
        result = compute_fd_up_down_volume('2022-01-12', 1976980787.0, 2288144345.0)
        self.assertEqual(result, 53.79)
...
class TestTODAverageHighsLows(unittest.TestCase):
    def test_answer(self):
        """Found correct answer"""
        result = compute_tod_avg_highs_lows('2022-01-12', -74.0)
        self.assertEqual(result, -228.0)
        
        
class TestSTDAverageHighsLows(unittest.TestCase):
    def test_answer(self):
        """Found correct answer"""
        result = compute_std_avg_highs_lows('2022-01-12', -74.0)
        self.assertEqual(result, -128.03)
